...
public interface IBPASessionDao extends JpaRepository<BPASession,String>{
    ...
    @Query(value = "SELECT a.sessionid,b.startdatetime,a.enddatetime,a.processid,a.starterresourceid,a.statusid,a.stoprequested,a.lastupdated,a.laststage,b.logid,b.stagename,b.pagename,b.objectname,b.actionname,b.result " +
